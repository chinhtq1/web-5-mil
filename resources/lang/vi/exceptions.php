...
return [
	...
	"documents" => [
	"already_exists" => "That DocumentsManagement already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this DocumentsManagement. Please try again.",
	"delete_error" => "There was a problem deleting this DocumentsManagement. Please try again.",
	"not_found" => "That DocumentsManagement does not exist.",
	"update_error" => "There was a problem updating this DocumentsManagement. Please try again.",
	],
	"documentcategories" => [
	"already_exists" => "That DocumentCategoriesManagement already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this DocumentCategoriesManagement. Please try again.",
	"delete_error" => "There was a problem deleting this DocumentCategoriesManagement. Please try again.",
	"not_found" => "That DocumentCategoriesManagement does not exist.",
	"update_error" => "There was a problem updating this DocumentCategoriesManagement. Please try again.",
	],
	],
	"frontend" => [
	"auth" => [
	...
	"resend" => "Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href=http://demo2.test/account/confirm/resend/:user_id>click here</a> to resend the confirmation e-mail.",
