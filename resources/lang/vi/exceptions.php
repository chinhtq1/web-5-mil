...
return [
	...
	"documents" => [
	"create_error" => "There was a problem creating this Documents. Please try again.",
	"delete_error" => "There was a problem deleting this Documents. Please try again.",
	"not_found" => "That Documents does not exist.",
	"update_error" => "There was a problem updating this Documents. Please try again.",
	],
	"documentcategories" => [
	"already_exists" => "That Document Categories already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Document Categories. Please try again.",
	"delete_error" => "There was a problem deleting this Document Categories. Please try again.",
	"not_found" => "That Document Categories does not exist.",
	"update_error" => "There was a problem updating this Document Categories. Please try again.",
	],
	"events" => [
	...
	"create_time_error" => "Ngày bắt đầu lớn hơn ngày kết thúc.. Vui lòng thử lại.",
