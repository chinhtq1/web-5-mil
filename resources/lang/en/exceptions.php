...
return [
	...
	"files" => [
	"already_exists" => "That FileManager already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this FileManager. Please try again.",
	"delete_error" => "There was a problem deleting this FileManager. Please try again.",
	...
	"resend" => "Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href=http://demo1.test/account/confirm/resend/:user_id>click here</a> to resend the confirmation e-mail.",
