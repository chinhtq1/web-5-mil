...
@section('title')
    @isset($active_category) {{ $active_category->name }} @else {{ appSettings()->product_title ? '| '.appSettings()->product_title : '' }}  @endisset
@endsection

@section('meta')
    @include('frontend.products.partials.seo-index')
@endsection

@section('after-css')
    <link rel="stylesheet" href="{{ asset('css/frontend/chocolat.css') }}" type="text/css" media="screen"
          charset="utf-8">
@endsection
                ...
                <div class="col-md-9 blog-left">
                    <div class="row">
                        @foreach($products as $product)
                            <div class="col-md-4 col-lg-4   blog-one">
