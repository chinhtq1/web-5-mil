<div class="box-body">
    ...
    <div class="form-group">
        ...
        @if(!empty($blog->featured_image))
            <div class="col-lg-8">
                <p class="small text-gray">Kích thước ảnh đề xuất:  900 x 500 ( hoặc tỉ lệ: 3 x 2 )</p>
                <div class="row">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-6">
                        <img src="{{ Storage::disk('public')->url('img/blog/' . $blog->featured_image) }}" height="200" width="300">
                    </div>
                </div>
            </div>
        @else
