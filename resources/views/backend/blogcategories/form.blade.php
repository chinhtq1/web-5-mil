        ...
        <div class="form-group">
            {{ Form::label('slug', trans('validation.attributes.backend.blogcategories.slug'), ['class' => 'col-lg-2 control-label']) }}
    ...
    <div class="form-group">
        ...
        @section("after-scripts")
            <script type="text/javascript">
                Backend.BlogCategory.selectors.GenerateSlugUrl = "{{route('admin.generate.slug')}}";
                Backend.BlogCategory.selectors.SlugUrl = "{{url('/')}}";
                Backend.BlogCategory.init();
