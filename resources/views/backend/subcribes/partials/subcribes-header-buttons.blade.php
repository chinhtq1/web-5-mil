<!--Action Button-->
@if( Active::checkUriPattern( 'admin/subcribes' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.subcribes.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.subcribes.all' ) }}
            </a>
        </li>
        @permission( 'create-subcribe' )
            <li>
                <a href="{{ route( 'admin.subcribes.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.subcribes.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
