<div class="box-body">
    ...
    <div class="form-group">
        {{ Form::label('show', trans('validation.attributes.backend.events.show'), ['class' => 'col-lg-2 control-label']) }}

        <div class="col-lg-10">
            <div class="control-group">
                <label class="control control--checkbox">
                    @if(isset($product->show) && !empty ($product->show))
    ...
    <div class="form-group">
        ...
        @if(!empty($product->feature_image))
            <div class="col-lg-8">
                <p class="small text-gray">Kích thước ảnh đề xuất: 450 x 300 ( hoặc tỉ lệ: 3 x 2 )</p>
                <div class="row">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-6">
                        <img src="{{ Storage::disk('public')->url('img/product/' . $product->feature_image) }}" height="200" width="300">
                    </div>
                </div>
            </div>
        @else
