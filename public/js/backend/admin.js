            ...
            addHandlers: function () {
                ...
                this.selectors.name.onblur = function (event) {
                    ...
                    if (url !== '') {
                        callback = {
                            success: function (request) {
                                if (request.status >= 200 && request.status < 400) {
                                    ...
                                    Backend.BlogCategory.selectors.slug.value = Backend.BlogCategory.selectors.SlugUrl + '/' + response.trim();
                                }
                            },
                        ...
                        Backend.Utils.ajaxrequest(Backend.BlogCategory.selectors.GenerateSlugUrl, "post", {
                            text: url
                        }, Backend.Utils.csrf, callback);
                    }
                };
